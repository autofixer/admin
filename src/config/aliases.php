...
$config->alias([
    ...
    Queries\General::class => HOME . '/queries/General.php',
    Queries\Model::class => HOME . '/queries/Model.php',
    Queries\Data::class => HOME . '/queries/Data.php',
    Queries\ModelHelper::class => HOME . '/queries/ModelHelper.php',
    Queries\UnpackData::class => HOME . '/queries/UnpackData.php',
]);