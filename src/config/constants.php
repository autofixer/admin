...
if (preg_match('/(localhost)(:[0-9]+)/', $host)) :
    ...
    // set storage url
    $set->STORAGE_URL = 'http://localhost:8888/autofixer/cdn/';
    $set->SERVICE_API = 'http://localhost:8888/autofixer/services/fatapi';
    $set->MAIN_SITE = 'http://localhost:8888/autofixer/www';


else:

    // set services
    $set->STORAGE_URL = 'http://cdn.autofixer.com.ng';
    $set->SERVICE_API = 'http://api.autofixer.com.ng';
    $set->MAIN_SITE = 'http://autofixer.com.ng';
